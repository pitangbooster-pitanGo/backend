...
const managementActions = [
  ...
  'api::ai-suggestion.ai-suggestion.find',
  'api::ai-suggestion.ai-suggestion.findOne',
  'api::ai-suggestion.ai-suggestion.create',
  'api::ai-suggestion.ai-suggestion.approve',
  'api::ai-suggestion.ai-suggestion.reject',
...
export const seedUsersPermissions = async (strapi: Core.Strapi) => {
